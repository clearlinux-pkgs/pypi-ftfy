...
Source0  : https://files.pythonhosted.org/packages/a8/cf/b53c42f47090525740b30007a1f53e61088109a5d7eae8e41c8398a7ba7a/ftfy-6.2.0.tar.gz
...
%prep
%setup -q -n ftfy-6.2.0
cd %{_builddir}/ftfy-6.2.0
pushd ..
cp -a ftfy-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710608995
