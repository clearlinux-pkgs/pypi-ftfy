...
Source0  : https://files.pythonhosted.org/packages/da/a9/59f4354257e8350a25be1774021991fb3a99a2fb87d0c1f367592548aed3/ftfy-6.2.3.tar.gz
...
%prep
%setup -q -n ftfy-6.2.3
cd %{_builddir}/ftfy-6.2.3
pushd ..
cp -a ftfy-6.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722958062
