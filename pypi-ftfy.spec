...
%prep
%setup -q -n ftfy-6.1.1
cd %{_builddir}/ftfy-6.1.1
pushd ..
cp -a ftfy-6.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672273272
...
cp %{_builddir}/ftfy-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-ftfy/40b1ab35454e0324b65e18319bcbd0c2ed568090 || :
...
rm -f %{buildroot}*/usr/lib/python3.11/site-packages/CHANGELOG.md
rm -f %{buildroot}*/usr/lib/python3.11/site-packages/README.md
