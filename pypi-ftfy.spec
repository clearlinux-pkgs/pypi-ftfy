...
Source0  : https://files.pythonhosted.org/packages/dd/da/d177a95c12483cffd247f283846ac94f2cb7a9cd6fcf4b675a02a46ffd82/ftfy-6.1.3.tar.gz
...
%prep
%setup -q -n ftfy-6.1.3
cd %{_builddir}/ftfy-6.1.3
pushd ..
cp -a ftfy-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702067831
